...
namespace vulkan_autogen {
	Eternal<Function> DescriptorPool::constructor;
	...
	DescriptorPool::DescriptorPool(const FunctionCallbackInfo<Value>& args) {
		...
		vkCreateDescriptorPool = reinterpret_cast<PFN_vkCreateDescriptorPool>(vkGetDeviceProcAddr(ObjectWrap::Unwrap<Device>(parent_device.Get(isolate))->vulkan_handle,"vkCreateDescriptorPool"));
		vkDestroyDescriptorPool = reinterpret_cast<PFN_vkDestroyDescriptorPool>(vkGetDeviceProcAddr(ObjectWrap::Unwrap<Device>(parent_device.Get(isolate))->vulkan_handle,"vkDestroyDescriptorPool"));
		...
		vkCreateDescriptorPool(ObjectWrap::Unwrap<Device>(parent_device.Get(isolate))->vulkan_handle, &pCreateInfo, nullptr, &vulkan_handle);
	...
	DescriptorPool::~DescriptorPool() {
		...
		vkDestroyDescriptorPool(ObjectWrap::Unwrap<Device>(parent_device.Get(isolate))->vulkan_handle, vulkan_handle, nullptr);
